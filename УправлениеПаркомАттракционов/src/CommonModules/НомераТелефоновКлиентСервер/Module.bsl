...
//  
Функция НормализовнныйНомерТелефона(Телефон, ВызыватьИсключение = Ложь) Экспорт
	...
	Если Не СтрДлина(ЦифрыТелефона) = 11 Тогда
		Ошибки.Добавить("Номер телефона должен состоять из 11 цифр");
	КонецЕсли;
